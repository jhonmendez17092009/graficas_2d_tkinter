...
# dibujar texto
# ---------------------
texto_1 = c.create_text(BASE/4, ALTURA/4, anchor="center", text="Jhoasnel Jose", font=("arial", 25, "bold"), fill="blue", activefill="yellow")
...
# poligonos
#---------------------
poligonos_1 = c.create_polygon(0, 0, BASE/2, ALTURA/2,0,ALTURA,fill="red",outline="red")
...
# arcos
#---------------------
arcos_1 = c.create_arc(BASE/2-30,ALTURA/2-30,BASE/2+30,ALTURA/2+30, start=45,extent=270, fill= "black")
